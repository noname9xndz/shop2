    ...
    function productImportController(apiService, $http, authenticationService, $scope, notificationService, $state, commonService) {
        ...
        $scope.$on("fileSelected", function (event, args) {
            $scope.$apply(function () {
                $scope.files.push(args.file); // mỗi lần có event trong directive => import vào $scope.files = [];
            });
        });
        ...
        function ImportProduct() {
            ...
            $http({
                ...
                headers: { 'Content-Type': undefined }, // khi post 1 request vừa có dữ liệu form + datafile => 'Content-Type': undefined
